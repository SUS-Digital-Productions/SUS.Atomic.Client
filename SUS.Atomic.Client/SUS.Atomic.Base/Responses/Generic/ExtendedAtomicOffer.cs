...
{
    public class ExtendedAtomicOffer<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>
    {
        ...
        public List<ExtendedAtomicAsset<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>> SenderAssets { get; set; }

        [JsonProperty("recipient_assets")]
        public List<ExtendedAtomicAsset<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>> RecipientAssets { get; set; }
