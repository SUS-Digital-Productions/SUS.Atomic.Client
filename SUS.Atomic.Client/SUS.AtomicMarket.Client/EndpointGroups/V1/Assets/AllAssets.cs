...
using SUS.AtomicMarket.Client.Responses.V1.Assets.AllAssets;
...
namespace SUS.AtomicMarket.Client.EndpointGroups.V1.Assets
{
    public class AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>
        ...
        IBurnedAssetsFilterable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        IOwnerFillterable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        ...
        IMinterFilterable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        IBurnerFilterable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        IInitialReceiverFilterable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        ICollectionBlocklistable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        ICollectionAllowlistable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        IOnlyDuplicateTemplatesFilterable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        IHasBackedTokensFilterable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        IHasTemplateBuyofferFilterable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        IAuthorizedAccountFilterable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        ITemplateAllowlistable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        ITemplateBlocklistable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
        IHideTemplatesByAccountsFilterable<AllAssets<TemplateImmutableData, AssetImmutableData, AssetMutableData, CombinedData>>,
